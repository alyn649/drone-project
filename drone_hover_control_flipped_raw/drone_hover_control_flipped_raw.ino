...
void loop() {
  ...
  baseThrottle = map(analogRead(A0), 0, 1023, 0, 300);
  ...
  Serial.print("motorA:");
  Serial.print(motorA._packet);
  Serial.print(" motorB:");
  Serial.print(motorB._packet);
  Serial.print(" motorC:");
  Serial.print(motorC._packet);
  Serial.print(" motorD:");
  Serial.println(motorD._packet);
